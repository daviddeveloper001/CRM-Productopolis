        ...
        DB::transaction(function () use ($datos) {
            ...
            foreach ($datos['data'] as $registro) {
                ...
                $sale = Sale::create([
                    ...
                    "last_order_date_delivered" => $registro['fecha_ultima_orden_entregada'],
                    ...
                    'previous_last_item_purchased' => $registro['antepenultimo_item_comprado'],
                    'days_since_last_purchase' => $registro['ultimos_dias_compra'],
